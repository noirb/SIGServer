/* $Id: CTReader.cpp,v 1.1.1.1 2011-03-25 02:18:50 okamoto Exp $ */
#include "CTReader.h"
...
CTReader::CTReader(SOCKET s, CommDataDecoder &d, int bufsize)
  : m_sock(s), m_source(s), m_decoder(d), m_buf(NULL)
{
