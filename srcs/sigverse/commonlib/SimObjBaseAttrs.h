...
//
// For example, DEFINE_ATTR_DOUBLE(x, "x") will be expanded as:
// double x() const
//{
//  return getAttr("x").value().getDouble();
//}
//void x(double v)
//{
//  getAttr("x").value().setDouble(v);
//}
//by the definition written in SimObjBase.h
//
