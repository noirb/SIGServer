...
if(WIN32)
    target_link_libraries(sendmsg  Ws2_32 x3dparser jvm)
    target_link_libraries(sigstart Ws2_32 x3dparser jvm)
    target_link_libraries(sigend   Ws2_32 x3dparser jvm)
    ...
    target_link_libraries(sendmsg  debug xerces-c_3D  optimized xerces-c_3)
    target_link_libraries(sigstart debug xerces-c_3D  optimized xerces-c_3)
    target_link_libraries(sigend   debug xerces-c_3D  optimized xerces-c_3)
#    target_link_libraries(sendmsg  jvm ode xerces-c_3)
#    target_link_libraries(sigstart jvm ode xerces-c_3)
#    target_link_libraries(sigend   jvm ode xerces-c_3)
